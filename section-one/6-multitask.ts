...
// What will happen??
/**
 *  File will be interpreted immediatly
...
// doWork2(15000).then((result) => console.log('Loging doWork result', result));
// method(1);
// doWork2(2000).then((result) => console.log('Loging doWork result', result));
// method(2);

 ...
 * Inside the thread is the event loop. The event loop controlls what the thread is doing at any given time.
 */
...
while (shouldContinue()) {
  ...
  // 2. Node checks pendingTasks and pendingOperations and calls relevent callbacks
